...
import { addSignature, relaySignedTransaction, toPayload, } from "./utils/transaction";
import { isSignMethod, signMethods } from "./types";
...
export class Beta {
    ...
    async handleSessionRequest(request) {
        ...
        if (!isSignMethod(method)) {
            throw new Error(`Unsupported sign method ${method}: Available sign methods ${signMethods}`);
        }
