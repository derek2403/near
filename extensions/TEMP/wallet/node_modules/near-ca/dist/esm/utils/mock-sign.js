...
import { fromPayload, nearAccountFromAccountId, NearEthAdapter, } from "..";
/**
...
export class MockMpcContract {
    connectedAccount;
    ethAccount;
    constructor(account, privateKey) {
        this.connectedAccount = account;
        this.ethAccount = privateKeyToAccount(privateKey ||
    ...
    deriveEthAddress = async (_unused) => {
        return this.ethAccount.address;
    };
    getDeposit = async () => {
        return "1";
    };
    requestSignature = async (signArgs, _gas) => {
...
export async function mockAdapter(privateKey) {
