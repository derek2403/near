...
import { configFromNetworkId, createNearAccount, getNetworkId, } from "./chains/near";
 ...
 */
export async function setupAdapter(args) {
    ...
    let account;
    try {
        account = await createNearAccount(accountId, config, 
